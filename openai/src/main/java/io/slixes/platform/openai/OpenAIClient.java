...
import io.slixes.platform.openai.openai.chat.ChatCompletionChunk;
import io.slixes.platform.openai.openai.chat.ChatCompletionRequest;
import io.slixes.platform.openai.openai.completion.CompletionChunk;
import io.slixes.platform.openai.openai.completion.CompletionRequest;
import io.slixes.platform.openai.openai.completion.CompletionResult;
...
import io.slixes.platform.openai.openai.audio.TranscriptionRequest;
import io.slixes.platform.openai.openai.audio.TranscriptionResponse;
import io.slixes.platform.openai.openai.audio.TranslationRequest;
import io.slixes.platform.openai.openai.chat.ChatCompletionResult;
import io.slixes.platform.openai.openai.model.Model;
import io.slixes.platform.openai.openai.moderation.ModerationRequest;
import io.slixes.platform.openai.openai.moderation.ModerationResponse;
